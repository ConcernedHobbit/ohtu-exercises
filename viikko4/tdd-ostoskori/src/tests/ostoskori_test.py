...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_korissa_ostos_samalla_nimella_ja_lukumaaralla_kaksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
        ostos = self.kori.ostokset()[0]
    ...
    def test_kahdesta_samasta_tuotteesta_yhden_poistaminen_jattaa_ostoksen_lukumaaralla_yksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_ostos_poistuu_kun_viimeinen_tuote_poistetaan(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.poista_tuote(self.maito)
